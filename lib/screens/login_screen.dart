          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: kTextFieldDecoration.copyWith(hintText: '請輸入登入信箱'), // 方法寫在 constants.dart中 並使用copywith更改預設屬性
              ),
              SizedBox(
                height: 8.0,
              ),
              TextField(
                ...
                decoration: kTextFieldDecoration.copyWith(hintText: '請輸入登入密碼'), // 方法寫在 constants.dart中 並使用copywith更改預設屬性
              ),
              SizedBox(
                height: 24.0,
              ),
